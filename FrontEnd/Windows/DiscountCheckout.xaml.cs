        ...
        private void SaveButton_Click(object sender, RoutedEventArgs e)
        {
                ...
                if (customerDiscount != null)
                {
                    ...
                    if (customerDiscounts != null)
                    {
                        ...
                        InvoiceDB.UpdateInvoice(new Invoice(InvoiceId, invoice.VisitID, invoice.VisitTotalCosts,
                            visit.Room_ID ,invoice.Room_Costs, invoice.Service_Costs, invoice.Restaurant_Costs,
                            discount, 0, invoice.Tax_Id, invoice.Tax_Sum, invoice.Created_At,
            ...
            else
            {
                ...
                if (specialOffer != null)
                {
                    ...
                    InvoiceDB.UpdateInvoice(new Invoice(InvoiceId, invoice.VisitID, invoice.VisitTotalCosts,
                        visit.Room_ID,invoice.Room_Costs, invoice.Service_Costs, invoice.Restaurant_Costs,
                        0, discount, invoice.Tax_Id, invoice.Tax_Sum, invoice.Created_At, 
                        invoice.Paid, invoice.Deleted));
